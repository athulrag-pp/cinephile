...
app = FastAPI(title="Cinephile API — Infinite Live Web Search & Multi-Language Movie Engine")
...
def get_multi_language_catalog(language: str, mood: str, genres: list[str], count: int = 50) -> list[dict]:
    lang_lower = (language or "any").lower()
    req_genres_lower = [g.lower() for g in (genres or [])]
    
    all_catalog_movies = [
        # Tamil 🎬
        {"title": "Doctor", "year": 2021, "director": "Nelson Dilipkumar", "rating": 7.8, "why": "A hilarious Tamil action-comedy.", "tags": ["Comedy", "Action", "Crime"], "language": "Tamil", "mood_match": 98},
        {"title": "Boss Engira Bhaskaran", "year": 2010, "director": "M. Rajesh", "rating": 7.5, "why": "A classic Tamil romantic comedy.", "tags": ["Comedy", "Romance"], "language": "Tamil", "mood_match": 96},
        {"title": "Soodhu Kavvum", "year": 2013, "director": "Nalan Kumarasamy", "rating": 8.3, "why": "A cult Tamil dark comedy about four kidnappers.", "tags": ["Comedy", "Crime"], "language": "Tamil", "mood_match": 97},
        {"title": "Comali", "year": 2019, "director": "Pradeep Ranganathan", "rating": 7.0, "why": "A fun Tamil comedy about a man waking from coma.", "tags": ["Comedy", "Drama"], "language": "Tamil", "mood_match": 94},
        {"title": "Panchatanthiram", "year": 2002, "director": "K. S. Ravikumar", "rating": 8.1, "why": "An iconic Kamal Haasan Tamil comedy masterpiece.", "tags": ["Comedy"], "language": "Tamil", "mood_match": 97},
        {"title": "Vikram", "year": 2022, "director": "Lokesh Kanagaraj", "rating": 8.3, "why": "A high-octane Tamil action thriller featuring Kamal Haasan.", "tags": ["Action", "Thriller", "Crime"], "language": "Tamil", "mood_match": 98},
        {"title": "Kaithi", "year": 2019, "director": "Lokesh Kanagaraj", "rating": 8.5, "why": "A relentless Tamil action thriller.", "tags": ["Action", "Thriller"], "language": "Tamil", "mood_match": 97},
        {"title": "Leo", "year": 2023, "director": "Lokesh Kanagaraj", "rating": 7.2, "why": "An explosive Vijay Tamil action thriller.", "tags": ["Action", "Thriller"], "language": "Tamil", "mood_match": 96},
        {"title": "Master", "year": 2021, "director": "Lokesh Kanagaraj", "rating": 7.8, "why": "A stylish Vijay vs Vijay Sethupathi clash.", "tags": ["Action", "Thriller"], "language": "Tamil", "mood_match": 95},
        {"title": "Jai Bhim", "year": 2021, "director": "T. J. Gnanavel", "rating": 8.8, "why": "A powerful Tamil legal drama.", "tags": ["Drama", "Crime"], "language": "Tamil", "mood_match": 98},
        {"title": "Ratsasan", "year": 2018, "director": "Ram Kumar", "rating": 8.3, "why": "An edge-of-seat Tamil serial killer thriller.", "tags": ["Thriller", "Crime", "Mystery"], "language": "Tamil", "mood_match": 97},
        {"title": "Pizza", "year": 2012, "director": "Kartik Subbaraj", "rating": 8.0, "why": "A chilling Tamil horror thriller.", "tags": ["Horror", "Thriller"], "language": "Tamil", "mood_match": 95},
        {"title": "96", "year": 2018, "director": "C. Prem Kumar", "rating": 8.5, "why": "A soulful Tamil romantic drama.", "tags": ["Romance", "Drama"], "language": "Tamil", "mood_match": 96},
        {"title": "24", "year": 2016, "director": "Vikram Kumar", "rating": 7.8, "why": "An inventive Tamil sci-fi time-travel thriller.", "tags": ["Sci-Fi", "Action"], "language": "Tamil", "mood_match": 95},
        ...
        {"title": "Aavesham", "year": 2024, "director": "Jithu Madhavan", "rating": 8.0, "why": "An energetic Malayalam action-comedy.", "tags": ["Action", "Comedy"], "language": "Malayalam", "mood_match": 96},
        {"title": "Guruvayoor Ambalanadayil", "year": 2024, "director": "Vipinchandran", "rating": 7.3, "why": "A fun Malayalam wedding comedy.", "tags": ["Comedy", "Drama"], "language": "Malayalam", "mood_match": 95},
        {"title": "Super Sharanya", "year": 2022, "director": "Girish A.D.", "rating": 7.0, "why": "A relatable Malayalam campus comedy.", "tags": ["Comedy", "Drama"], "language": "Malayalam", "mood_match": 94},
        {"title": "Thanneer Mathan Dinangal", "year": 2019, "director": "Girish A.D.", "rating": 7.9, "why": "A delightful Malayalam high-school comedy-drama.", "tags": ["Comedy", "Romance"], "language": "Malayalam", "mood_match": 95},
        {"title": "Manjummel Boys", "year": 2024, "director": "Chidambaram", "rating": 8.5, "why": "A gripping Malayalam survival thriller.", "tags": ["Thriller", "Survival", "Drama"], "language": "Malayalam", "mood_match": 96},
        {"title": "Drishyam", "year": 2013, "director": "Jeethu Joseph", "rating": 8.6, "why": "The legendary Malayalam crime thriller.", "tags": ["Thriller", "Crime", "Drama"], "language": "Malayalam", "mood_match": 98},
        {"title": "Drishyam 2", "year": 2021, "director": "Jeethu Joseph", "rating": 8.4, "why": "The explosive Malayalam sequel.", "tags": ["Thriller", "Crime", "Sequel"], "language": "Malayalam", "mood_match": 97},
        {"title": "Kishkindha Kaandam", "year": 2024, "director": "Dinjith Ayyathan", "rating": 8.4, "why": "A brilliant Malayalam mystery thriller.", "tags": ["Mystery", "Thriller"], "language": "Malayalam", "mood_match": 96},
        {"title": "Bramayugam", "year": 2024, "director": "Rahul Sadasivan", "rating": 7.9, "why": "A haunting Malayalam folklore horror thriller.", "tags": ["Horror", "Mystery"], "language": "Malayalam", "mood_match": 95},
        ...
        # Hindi 🇮🇳
        {"title": "3 Idiots", "year": 2009, "director": "Rajkumar Hirani", "rating": 8.4, "why": "An iconic Hindi comedy-drama.", "tags": ["Comedy", "Drama"], "language": "Hindi", "mood_match": 98},
        {"title": "Stree", "year": 2018, "director": "Amar Kaushik", "rating": 7.5, "why": "A hilarious Hindi horror-comedy.", "tags": ["Comedy", "Horror"], "language": "Hindi", "mood_match": 95},
        {"title": "Hera Pheri", "year": 2000, "director": "Priyadarshan", "rating": 8.1, "why": "The ultimate Hindi cult comedy.", "tags": ["Comedy", "Crime"], "language": "Hindi", "mood_match": 98},
        {"title": "Golmaal: Fun Unlimited", "year": 2006, "director": "Rohit Shetty", "rating": 7.5, "why": "A hilarious Hindi slapstick comedy.", "tags": ["Comedy"], "language": "Hindi", "mood_match": 96},
        {"title": "Andhadhun", "year": 2018, "director": "Sriram Raghavan", "rating": 8.2, "why": "A dark Hindi thriller.", "tags": ["Thriller", "Crime"], "language": "Hindi", "mood_match": 96},
        {"title": "Tumbbad", "year": 2018, "director": "Rahi Anil Barve", "rating": 8.2, "why": "A visually stunning Hindi horror thriller.", "tags": ["Horror", "Fantasy"], "language": "Hindi", "mood_match": 95},

        # English 🇺🇸
        {"title": "Knives Out", "year": 2019, "director": "Rian Johnson", "rating": 7.9, "why": "A sharp, entertaining whodunit comedy-mystery.", "tags": ["Comedy", "Mystery", "Crime"], "language": "English", "mood_match": 96},
        {"title": "The Hangover", "year": 2009, "director": "Todd Phillips", "rating": 7.7, "why": "An outrageously funny comedy.", "tags": ["Comedy"], "language": "English", "mood_match": 97},
        {"title": "Superbad", "year": 2007, "director": "Greg Mottola", "rating": 7.6, "why": "A classic teenage comedy.", "tags": ["Comedy"], "language": "English", "mood_match": 95},
        {"title": "Interstellar", "year": 2014, "director": "Christopher Nolan", "rating": 8.7, "why": "A breathtaking sci-fi odyssey.", "tags": ["Sci-Fi", "Drama"], "language": "English", "mood_match": 98},
        {"title": "Inception", "year": 2010, "director": "Christopher Nolan", "rating": 8.8, "why": "A mind-bending sci-fi heist thriller.", "tags": ["Sci-Fi", "Action"], "language": "English", "mood_match": 97},
        {"title": "Dune: Part One", "year": 2021, "director": "Denis Villeneuve", "rating": 8.0, "why": "An epic sci-fi adventure.", "tags": ["Sci-Fi", "Adventure"], "language": "English", "mood_match": 96},
        {"title": "Dune: Part Two", "year": 2024, "director": "Denis Villeneuve", "rating": 8.6, "why": "The explosive sci-fi continuation.", "tags": ["Sci-Fi", "Action"], "language": "English", "mood_match": 98},
        {"title": "The Conjuring", "year": 2013, "director": "James Wan", "rating": 7.5, "why": "A terrifying supernatural horror.", "tags": ["Horror", "Mystery"], "language": "English", "mood_match": 95}
    ]
...
async def recommend(req: RecommendRequest):
    ...
    # 2. Multi-page live web search for extensive movie lists (pages 1 to 5)
        ...
        try:
            async with httpx.AsyncClient(timeout=4.0) as http_client:
                for page in range(1, 6):
                    ...
                    search_url = f"https://www.omdbapi.com/?s={httpx.URL(query_str).raw_path.decode()}&type=movie&page={page}&apikey={OMDB_API_KEY}"
            ...
            print(f"Multi-page web search error: {e}")
...
async def search_movies(q: str = Query(..., min_length=1)):
    """Search movie title to fetch ALL matching parts and ALL unique live web movie suggestions without 8-item caps!"""
    q_clean = q.strip()
    matching_movies = []
    seen_titles = set()
    seen_ids = set()
    ...
    # 1. Fetch all matching parts across pages 1 and 2
    try:
        async with httpx.AsyncClient(timeout=4.0) as http_client:
            for page in range(1, 3):
                url = f"https://www.omdbapi.com/?s={httpx.URL(q_clean).raw_path.decode()}&type=movie&page={page}&apikey={OMDB_API_KEY}"
                res = await http_client.get(url)
                if res.status_code == 200:
                    data = res.json()
                    if data.get("Response") == "True":
                        ...
                        for idx, item in enumerate(search_results):
                            ...
                            if len(matching_movies) == 0 and item_details.get("genres"):
                            ...
                            part_label = f"Part {len(matching_movies) + 1}" if ("2" in title or "3" in title or "part" in title.lower() or len(matching_movies) > 0) else "Part 1"
                            ...
                            matching_movies.append({
                                ...
                                "mood_match": 100 if len(matching_movies) == 0 else 96,
    ...
    # 2. Fetch genre recommendations if matching movies < 12
    if len(matching_movies) < 12 and primary_genres:
        genre_term = primary_genres[0]
        try:
            async with httpx.AsyncClient(timeout=4.0) as http_client:
                for g_page in range(1, 3):
                    g_url = f"https://www.omdbapi.com/?s={httpx.URL(genre_term + ' movie').raw_path.decode()}&type=movie&page={g_page}&apikey={OMDB_API_KEY}"
                    res = await http_client.get(g_url)
                    if res.status_code == 200:
                        g_data = res.json()
                        if g_data.get("Response") == "True":
                            for g_item in g_data.get("Search", []):
...
@app.get("/health")
async def health():
    return {"status": "ok", "message": "Cinephile API (Multi-Page Infinite Search Engine) is running"}
